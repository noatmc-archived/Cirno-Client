...
class KillAura : Module() {
    ...
    fun onRender3D(event: Render3DEvent) {
        ...
        if (markValue.get() && !targetModeValue.get().equals("Multi", ignoreCase = true))
            RenderUtils.drawEntityBox(target, if (hitable) Color(191, 13, 0, 255) else Color(0, 155, 0, 255),false)
    ...
    private fun runAttack() {
        ...
        RenderUtils.drawEntityBox(target, if (hitable) Color(255, 0, 0, 255) else Color(0, 155, 0, 255),true)
        // Settings
