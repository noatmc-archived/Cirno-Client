...
class GuiMainMenu : WrappedGuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        Fonts.fontBold180.drawCenteredString("Cirno", representedScreen.width / 2F, representedScreen.height / 8F, 4673984, true)
        Fonts.font35.drawCenteredString("b" + "Cirno", representedScreen.width / 2F + 148, representedScreen.height / 8F + Fonts.font35.fontHeight, 0xffffff, true)
