...
class GuiWelcome : WrappedGuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        font.drawCenteredString("Here is some information you might find useful if you are using Cirno Client for the first time.", representedScreen.width / 2F, representedScreen.height / 8F + 70 + font.fontHeight, 0xffffff, true)
