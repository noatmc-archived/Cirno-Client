...
class TabGUI(x: Double = 5.0, y: Double = 25.0) : Element(x = x, y = y) {
    ...
    private val greenValue = IntegerValue("Rectangle Green", 255, 0, 255)
    private val blueValue = IntegerValue("Rectangle Blue", 0, 0, 255)
    ...
    private val backgroundRedValue = IntegerValue("Background Red", 16, 0, 255)
    private val backgroundGreenValue = IntegerValue("Background Green", 124, 0, 255)
    ...
    private val borderRainbow = BoolValue("Border Rainbow", true)
